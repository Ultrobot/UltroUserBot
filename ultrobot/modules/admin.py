...
from ultrobot import BOTLOG, BOTLOG_CHATID, BRAIN_CHECKER, CMD_HELP, bot, WARN_MODE, WARN_LIMIT, WHITELIST
from ultrobot.events import register
from ultrobot.main import PLUGIN_MESAJLAR
...
async def gbanspider(gspdr):
    ...
    try:
        from ultrobot.modules.sql_helper.gban_sql import gban
    except:
...
async def gbanmsg(moot):
    ...
    try:
        from ultrobot.modules.sql_helper.gban_sql import is_gbanned
    except:
        return
...
async def ungban(un_gban):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        from ultrobot.modules.sql_helper.gban_sql import ungban
    except:
...
async def spider(spdr):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        from ultrobot.modules.sql_helper.spam_mute_sql import mute
    except:
...
async def unmoot(unmot):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        from ultrobot.modules.sql_helper.spam_mute_sql import unmute
    except:
...
async def muter(moot):
    ...
    try:
        from ultrobot.modules.sql_helper.spam_mute_sql import is_muted
        from ultrobot.modules.sql_helper.gmute_sql import is_gmuted
    except:
        return
...
async def ungmoot(un_gmute):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        from ultrobot.modules.sql_helper.gmute_sql import ungmute
    except:
...
async def gspider(gspdr):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        from ultrobot.modules.sql_helper.gmute_sql import gmute
    except:
        await gspdr.edit(NO_SQL)
        return
...
async def unwarn(event):
    ...
    # Fonksiyonun SQL modu altında çalışıp çalışmadığını kontrol et
    try:
        import ultrobot.modules.sql_helper.warn_sql as warn
    except:
