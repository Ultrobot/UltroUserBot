...
async def fstat(event):
    ...
    if event.pattern_match.group(1):
        ultro = event.pattern_match.group(1)
    else:
        ultro = ""
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedstat " + kullanıcı + " " + ultro)
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedstat " + ultro)
                fedstat = await conv.get_response()
                if "file" in fedstat.text:
                    await fedstat.click(0)
                    reply = await conv.get_response()
...
async def info(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/info " + ultro)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fedinfo(event):
    if event.fwd_from:
        return
    ultro = event.pattern_match.group(1)
    if ultro == "" and not event.reply_to_msg_id:
        async with event.client.conversation(chat) as conv:
            try:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedinfo " + ultro)
                fedinfo = await conv.get_response()
                await event.client.forward_messages(event.chat_id, fedinfo)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fban(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fban " + ultro)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def unfban(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/unfban " + ultro)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fpromode(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fpromode " + ultro)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
