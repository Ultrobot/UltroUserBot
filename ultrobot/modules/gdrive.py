...
from ultrobot import (G_DRIVE_CLIENT_ID, G_DRIVE_CLIENT_SECRET,
...
import httplib2
from ultrobot.modules.upload_download import progress, humanbytes
...
async def upload_file(http, file_path, file_name, mime_type, event, parent_id):
    ...
    body = {
        "title": file_name,
        "description": "Ultro UserBot kullanılarak yüklendi.",
        "mimeType": mime_type,
    }
    if parent_id:
