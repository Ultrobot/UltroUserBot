...
async def welcome_to_chat(event):
    try:
        from ultrobot.modules.sql_helper.welcome_sql import get_current_welcome_settings
        from ultrobot.modules.sql_helper.welcome_sql import update_previous_welcome
    except:
        return
...
async def save_welcome(event):
    try:
        from ultrobot.modules.sql_helper.welcome_sql import add_welcome_setting
    except:
...
async def del_welcome(event):
    try:
        from ultrobot.modules.sql_helper.welcome_sql import rm_welcome_setting
    except:
        await event.edit("`SQL dışı modda çalışıyor!`")
        return
