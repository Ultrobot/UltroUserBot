...
from ultrobot import TEMP_DOWNLOAD_DIRECTORY, bot, DEFAULT_BIO,DEFAULT_NAME, BRAIN_CHECKER, WHITELIST
...
async def clone(event):
    ...
    await event.client.send_message(
      event.chat_id,
      "`Hahahah, Ultro Sayesinde Seni Çaldım.`",
